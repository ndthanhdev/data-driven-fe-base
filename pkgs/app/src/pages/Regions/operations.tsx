...
export type FetchRegionsPageQueryVariables = Exact<{ [key: string]: never; }>;


export type FetchRegionsPageQuery = (
  { __typename?: 'Query' }
  & { regions: Maybe<Array<Maybe<(
    ...
    & { subregions: Maybe<Array<Maybe<(
      { __typename?: 'Subregion' }
      & Pick<Subregion, '_id' | 'name'>
    )>>> }
  )>>> }
);


export const FetchRegionsPageDocument = gql`
...
/**
 * __useFetchRegionsPageQuery__
 *
 * To run a query within a React component, call `useFetchRegionsPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useFetchRegionsPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFetchRegionsPageQuery({
 *   variables: {
 *   },
 * });
 */
export function useFetchRegionsPageQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FetchRegionsPageQuery, FetchRegionsPageQueryVariables>) {
        return ApolloReactHooks.useQuery<FetchRegionsPageQuery, FetchRegionsPageQueryVariables>(FetchRegionsPageDocument, baseOptions);
      }
export function useFetchRegionsPageLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FetchRegionsPageQuery, FetchRegionsPageQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FetchRegionsPageQuery, FetchRegionsPageQueryVariables>(FetchRegionsPageDocument, baseOptions);
        }
export type FetchRegionsPageQueryHookResult = ReturnType<typeof useFetchRegionsPageQuery>;
export type FetchRegionsPageLazyQueryHookResult = ReturnType<typeof useFetchRegionsPageLazyQuery>;
export type FetchRegionsPageQueryResult = ApolloReactCommon.QueryResult<FetchRegionsPageQuery, FetchRegionsPageQueryVariables>;