...
export type AllNationsPageFieldsFragment = (
  { __typename?: 'Country' }
  & Pick<Country, '_id'>
);

export type AllNationsPageQueryVariables = Exact<{ [key: string]: never; }>;


export type AllNationsPageQuery = (
  { __typename?: 'Query' }
  & { countries?: Maybe<Array<Maybe<(
    { __typename?: 'Country' }
    & AllNationsPageFieldsFragment
  )>>> }
);

export type CountryTileFieldsFragment = (
  { __typename?: 'Country' }
  & Pick<Country, 'name' | 'capital'>
  & { flag?: Maybe<(
    { __typename?: 'Flag' }
    & Pick<Flag, 'svgFile'>
  )> }
...
export type CountryTileQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type CountryTileQuery = (
  { __typename?: 'Query' }
  & { country?: Maybe<Array<Maybe<(
    { __typename?: 'Country' }
    & CountryTileFieldsFragment
  )>>> }
);

export const AllNationsPageFieldsFragmentDoc = gql`
    fragment AllNationsPageFields on Country {
  _id
}
    `;
export const CountryTileFieldsFragmentDoc = gql`
    fragment CountryTileFields on Country {
  name
  capital
  flag {
    svgFile
    ...
    `;
export const AllNationsPageDocument = gql`
    query allNationsPage {
  countries: Country {
    ...AllNationsPageFields
  }
}
    ${AllNationsPageFieldsFragmentDoc}`;

/**
 * __useAllNationsPageQuery__
 *
 * To run a query within a React component, call `useAllNationsPageQuery` and pass it any options that fit your needs.
 * When your component renders, `useAllNationsPageQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useAllNationsPageQuery({
 *   variables: {
 *   },
 * });
 */
export function useAllNationsPageQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<AllNationsPageQuery, AllNationsPageQueryVariables>) {
        return ApolloReactHooks.useQuery<AllNationsPageQuery, AllNationsPageQueryVariables>(AllNationsPageDocument, baseOptions);
      }
export function useAllNationsPageLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<AllNationsPageQuery, AllNationsPageQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<AllNationsPageQuery, AllNationsPageQueryVariables>(AllNationsPageDocument, baseOptions);
        }
export type AllNationsPageQueryHookResult = ReturnType<typeof useAllNationsPageQuery>;
export type AllNationsPageLazyQueryHookResult = ReturnType<typeof useAllNationsPageLazyQuery>;
export type AllNationsPageQueryResult = ApolloReactCommon.QueryResult<AllNationsPageQuery, AllNationsPageQueryVariables>;
export const CountryTileDocument = gql`
    query countryTile($id: String!) {
  country: Country(_id: $id) {
    ...CountryTileFields
  }
}
    ${CountryTileFieldsFragmentDoc}`;

/**
 * __useCountryTileQuery__
 *
 * To run a query within a React component, call `useCountryTileQuery` and pass it any options that fit your needs.
 * When your component renders, `useCountryTileQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useCountryTileQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useCountryTileQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<CountryTileQuery, CountryTileQueryVariables>) {
        return ApolloReactHooks.useQuery<CountryTileQuery, CountryTileQueryVariables>(CountryTileDocument, baseOptions);
      }
export function useCountryTileLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<CountryTileQuery, CountryTileQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<CountryTileQuery, CountryTileQueryVariables>(CountryTileDocument, baseOptions);
        }
export type CountryTileQueryHookResult = ReturnType<typeof useCountryTileQuery>;
export type CountryTileLazyQueryHookResult = ReturnType<typeof useCountryTileLazyQuery>;
export type CountryTileQueryResult = ApolloReactCommon.QueryResult<CountryTileQuery, CountryTileQueryVariables>;